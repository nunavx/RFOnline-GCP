        ...
        if( hasPermissions($do) ) 
        {
            ...
            else
            {
                if( $page == "addedit" ) 
                {
                    ...
                    $item_ups = isset($_POST["item_ups"]) && is_int((int) $_POST["item_ups"]) ? antiject($_POST["item_ups"]) : 0;
                    $item_slots = isset($_POST["item_slots"]) && is_int((int) $_POST["item_slots"]) ? antiject($_POST["item_slots"]) : 0;
                    $item_talic = isset($_POST["item_talic"]) && is_int((int) $_POST["item_talic"]) ? antiject($_POST["item_talic"]) : 1;
...
function game_cp_5($catid, $nav = array(  ))
{
