        ...
        if( $isuser == true ) 
        {
            ...
            if( $page == "buy" ) 
            {
                ...
                if( $exit_buy == false ) 
                {
                    ...
                    gamecp_log(1, $userdata["username"], "" . "GAMECP - CONVERT POINTS - Char Serial: " . $char_serial . " | Exchanged: " . $config["specialcs_costpoint"] . " (GP) -> +" . number_format($premium) . " (P) & " . $config["specialcs_cashpoint"] . "");
                    return 1;
                }
